...
|------|-------------|------|---------|:--------:|
| <a name="input_azs"></a> [azs](#input\_azs) | list of azs to create all vpc resource | `list(string)` | `[]` | no |
...
| <a name="input_region"></a> [region](#input\_region) | The name of the selected region | `string` | n/a | yes |
